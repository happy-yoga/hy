...
;(function (root, factory) {
  ...
  var Rellax = function (el, options) {
    ...
    var createBlock = function (el) {
      ...
      var percentageY =
        dataPercentage || (posY - blockTop + screenY) / (blockHeight + screenY)
      var percentageX =
        dataPercentage || (posX - blockLeft + screenX) / (blockWidth + screenX)
      ...
      var speed = dataSpeed || self.options.speed
    ...
    var animate = function () {
      ...
      for (var i = 0; i < self.elems.length; i++) {
        ...
        var translate =
          'translate3d(' +
          (self.options.horizontal ? self.options.horizontal : '0px') +
          ',' +
